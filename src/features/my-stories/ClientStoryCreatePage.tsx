...
import { createSubmission } from '@/lib/services/story-submissions.service'
...
export function ClientStoryCreatePage() {
          ...
          <div className='flex items-center gap-3'>
            ...
            <div>
              ...
              <p className='text-sm text-muted-foreground'>
                Write and submit your story for editorial review
              </p>
            </div>
          </div>
