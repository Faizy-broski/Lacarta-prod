...
export function useFormState(fixedCategory?: string) {
  ...
  async function handleSave() {
    ...
    const payload: Record<string, unknown> = {
      ...
      whats_included: (isBoating || isGastronomy || isActivities || isBeach) ? form.whats_included : {},
      important_info: (isBoating || isGastronomy || isActivities || isBeach) ? form.important_info : {},
